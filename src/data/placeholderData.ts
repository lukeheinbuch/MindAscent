...
export const educationData: EducationCard[] = [
  ...
  // Added batch 11-20 from user request
  {
    id: 'ed-17',
    title: 'Simone Biles Opens Up About Mental Health at the Olympics',
    description: 'Elite perspective on prioritizing mental health during peak competition.',
    category: 'confidence',
    readTime: 6,
    content: '',
    url: 'https://www.youtube.com/watch?v=twx5ZJ8vWj8',
    tags: ['video', 'elite', 'mental-health', 'olympics'],
  },
  {
    id: 'ed-18',
    title: 'Michael Phelps on Depression and Seeking Help',
    description: 'Olympic legend shares personal journey with depression and recovery.',
    category: 'anxiety',
    readTime: 10,
    content: '',
    url: 'https://www.youtube.com/watch?v=aL2vNh5QkaA',
    tags: ['video', 'depression', 'recovery', 'elite'],
  },
  {
    id: 'ed-19',
    title: 'How Athletes Can Protect Their Mental Health',
    description: 'Actionable strategies to safeguard mental health in competitive environments.',
    category: 'recovery',
    readTime: 7,
    content: '',
    url: 'https://psychcentral.com/health/athletes-and-mental-health',
    tags: ['article', 'self-care', 'mental-health', 'tips'],
  },
  {
    id: 'ed-20',
    title: 'Sports Psychology: The Science of Mental Toughness',
    description: 'Foundations of developing resilience and mental toughness through psychology.',
  category: 'confidence',
    readTime: 12,
    content: '',
    url: 'https://www.youtube.com/watch?v=lg2nD3t8n7E',
    tags: ['video', 'performance', 'resilience', 'mental-toughness'],
  },
  {
    id: 'ed-21',
    title: 'Student-Athlete Mental Health: Challenges & Support',
    description: 'Explores academic pressure, identity, and support strategies for student-athletes.',
    category: 'anxiety',
    readTime: 6,
    content: '',
    url: 'https://www.bestcolleges.com/resources/student-athlete-mental-health/',
    tags: ['article', 'student-athlete', 'support', 'pressure'],
  },
  {
    id: 'ed-22',
    title: 'Mindfulness for Athletes',
    description: 'Applying mindfulness to enhance focus, calm, and performance consistency.',
  category: 'confidence',
    readTime: 8,
    content: '',
    url: 'https://www.youtube.com/watch?v=gH5rE2P7n9o',
    tags: ['video', 'mindfulness', 'focus', 'stress-reduction'],
  },
  {
    id: 'ed-23',
    title: 'Athlete Burnout: Warning Signs and Prevention',
    description: 'Recognizing early burnout indicators and building sustainable habits.',
    category: 'burnout',
    readTime: 5,
    content: '',
    url: 'https://www.psychologytoday.com/ca/blog/the-power-of-prime/201912/athlete-burnout-warning-signs-and-prevention',
    tags: ['article', 'burnout', 'prevention', 'recovery'],
  },
  {
    id: 'ed-24',
    title: 'Naomi Osaka on Mental Health and Taking Breaks',
    description: 'Advocacy and self-care through strategic rest and boundary setting.',
    category: 'confidence',
    readTime: 5,
    content: '',
    url: 'https://www.youtube.com/watch?v=uy0RrW8p0V4',
    tags: ['video', 'advocacy', 'self-care', 'elite'],
  },
  {
    id: 'ed-25',
    title: 'Coping With Injury: Mental Skills for Recovery',
    description: 'Psychological techniques to stay resilient and engaged during injury downtime.',
    category: 'injury',
    readTime: 8,
    content: '',
    url: 'https://believeperform.com/coping-with-injury-mental-skills-for-recovery/',
    tags: ['article', 'injury', 'skills', 'resilience'],
  },
  {
    id: 'ed-26',
    title: 'The Importance of Sleep for Athletic Performance and Mental Health',
    description: 'Sleep science fundamentals and its impact on recovery and mindset.',
    category: 'recovery',
    readTime: 7,
    content: '',
    url: 'https://thesportjournal.org/article/the-importance-of-sleep-for-athletic-performance-and-mental-health/',
    tags: ['article', 'sleep', 'recovery', 'performance'],
  },
];
...
export const resourcesData: Resource[] = [
  ...
  {
    id: 'r5',
    title: 'IOC Mental Health Resources for Athletes',
    description: 'International Olympic Committee hub for athlete mental health.',
    type: 'website',
    contact: 'https://olympics.com/ioc/mental-health',
    tags: ['athletes', 'IOC', 'resources', 'mental-health'],
  },
  {
    id: 'r6',
  ...
  {
    id: 'r8',
    title: 'Athletes for Hope – Whole Being Athlete Hub',
    description: 'Athlete wellness and mental health resource hub.',
    type: 'website',
    contact: 'https://www.athletesforhope.org/what-we-do/afh-mental-health/whole-being-athlete-resource-hub',
    tags: ['athletes', 'wellness', 'resource-hub'],
  },
  {
    id: 'r9',
    title: 'HeadsUpGuys',
